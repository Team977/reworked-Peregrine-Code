...
public class Math977 {
  ...
  public static Rotation3d getRotationBetweenObjectAndRobot(
      Translation3d object, Translation3d Robot) {
    return new Rotation3d(
        0,
        getRotationBetweanObjectAndRobotPitch(object, Robot).getRadians(),
        getRotationBetweanObjectAndRobotYaw(object, Robot).getRadians());
  }

  public static Rotation2d getRotationBetweanObjectAndRobotPitch(
      Translation3d object, Translation3d Robot) {
    return getAngleBetweenRobotAndObject(
        new Translation2d(
            object.toTranslation2d().getDistance(Robot.toTranslation2d()), object.getZ()),
        object.toTranslation2d());
  }

  public static Rotation2d getRotationBetweanObjectAndRobotYaw(
      Translation3d object, Translation3d Robot) {

    return getAngleBetweenRobotAndObject(object.toTranslation2d(), Robot.toTranslation2d());
  }

  /*
   * gets the angle between a static Object and the robot
   */
  public static Rotation2d getAngleBetweenRobotAndObject(
      Translation2d Object, Translation2d Robot) {
